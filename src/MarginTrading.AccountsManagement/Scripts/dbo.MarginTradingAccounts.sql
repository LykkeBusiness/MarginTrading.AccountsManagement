...
IF NOT EXISTS (
    ...
    WHERE t.object_id = object_id('MarginTradingAccounts') AND s.name = 'dbo' AND c.name = 'ReferenceAccount')
BEGIN
ALTER TABLE [dbo].[MarginTradingAccounts] ADD ReferenceAccount nvarchar(128) NULL;
END